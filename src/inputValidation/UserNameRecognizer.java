	...
	public static String checkForValidUserName(String input) {
		...
		while (running) {
			...
			case 0:
				...
				// The current character is checked against A-Z, a-z. If either is matched
			...
			case 1:
				...
				// 1: A-Z, a-z, 0-9 transitions back to state 1
				// 2: a period or ampersand transitions to state 2
			...
			case 2:
				// State 2 deals with a character after a period or ampersand in the name.
				// A-Z, a-z, 0-9 -> State 1
				if ((currentChar >= 'A' && currentChar <= 'Z' ) ||		// Check for A-Z
						(currentChar >= 'a' && currentChar <= 'z' ) ||	// Check for a-z
						(currentChar >= '0' && currentChar <= '9' )) {	// Check for 0-9
		...
		case 0:
			...
			userNameRecognizerErrorMessage +=
				"A UserName must start with A-Z or a-z.\n";
		...
		case 1:
			...
			if (userNameSize < 4) {
				...
				userNameRecognizerErrorMessage +=
					"A UserName may only contain A-Z, a-z, 0-9, dashes, underscores, periods, and ampersands.\n";
				return userNameRecognizerErrorMessage;
			}
			else {
					// UserName is valid
		...
		case 2:
			...
			userNameRecognizerErrorMessage +=
					"A UserName character after a dash, underscore, period, or ampersand must be A-Z, a-z, or 0-9.\n";
			return userNameRecognizerErrorMessage;
